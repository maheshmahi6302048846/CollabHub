    ...
    <div class="app-main">
      <header class="app-topbar">
        ...
        <div class="topbar-right">
          ...
          <!-- User Avatar Menu -->
          <div class="user-profile-menu" onclick="window.location.href='<?= base_url('creator/profile') ?>'">
            <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=120&q=80" alt="Priya Sharma" class="avatar">
            <div>
              <div style="font-weight:700; font-size:0.875rem; color:var(--gray-900);">Priya Sharma</div>
              <div style="font-size:0.75rem; color:var(--gray-500);">Creator &bull; Lifestyle</div>
            </div>
          </div>
        </div>
      </header>
